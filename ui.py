...
class QuizInterface:
    ...
    def get_the_next_question(self):
        ...
        if self.quiz.still_has_questions():
            ...
            self.canvas.itemconfig(self.question_text, text=f"Finish.\nYour score: {self.quiz.score}/10")
    ...
    def give_feedback(self, is_right):
        ...
        self.window.after(1000, self.get_the_next_question)
